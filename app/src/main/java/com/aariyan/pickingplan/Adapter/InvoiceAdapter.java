...
public class InvoiceAdapter extends RecyclerView.Adapter<InvoiceAdapter.ViewHolder> {
    ...
    public InvoiceAdapter(Context context, List<PlanModel> list) {
    ...
    public InvoiceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new InvoiceAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.single_plan_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull InvoiceAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
